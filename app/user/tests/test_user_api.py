...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_no_user(self):
        """Test that token is not creaeted if user doesn't exists"""
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        self.user = create_user(
            email='thanisorn.s@acommerce.asia',
            password='testpass',
            name='Thanisorn Sangkrajang'
        )
        self.client = APIClient()
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'test name', 'password': 'newpassword'}
